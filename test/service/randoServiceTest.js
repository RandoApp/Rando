...
//       sinon.stub(db.user, "getLightOutRandoByOrigianlFileName", function (email, originalFileName, callback) {
//         callback(null, {out: [{
//           randoId: "randoId",
//           creation: "creation",
//           imageURL: "imageURL",
...
//       randoService.saveImage({email: "user@mail.com"}, {path: "/tmp/some-image.png", size: 200, originalName: "some-image-original.png"}, {latitude: "32", longitude: "23"}, function (err) {
...
//       randoService.saveImage({user: "user@mail.com"}, {path: "/tmp/some-image.png", size: 200, originalName: "some-image-original.png"}, {latitude: "32", longitude: "23"}, function (err) {
...
//       randoService.saveImage({email: "user@mail.com", out:[], in:[]}, {path: "/tmp/some-image.png", size: 200, originalName: "some-image-original.png"}, {latitude: "32", longitude: "23"}, function (err) {
//         err.rando.should.be.eql(Errors.System(new Error()).rando);
...
//       randoService.saveImage({email: "user@mail.com", out:[], in:[]}, {path: "/tmp/some-image.png", size: 200, originalName: "some-image-original.png"}, {latitude: "32", longitude: "23"}, function (err, imageURL) {
